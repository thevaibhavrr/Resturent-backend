...
exports.createExpense = async (req, res) => {
    try {
        const { title, description, amount, staff: staffId, restaurantId } = req.body;
...
exports.getExpenses = async (req, res) => {
    try {
        const { restaurantId, startDate, endDate, minAmount, maxAmount } = req.query;
...
exports.updateExpense = async (req, res) => {
    try {
        const { title, description, amount, staff: staffId } = req.body;
